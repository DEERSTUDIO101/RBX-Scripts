--https://essencejs.github.io/syde/docs/intro
--https://essencejs.github.io/syde/docs/category/initialize
--https://essencejs.github.io/syde/docs/category/interactions
--https://essencejs.github.io/syde/docs/Example
...
local a = Window:InitTab({
	Title = 'AutoFarm', -- Set Title
	-- Locked = false
	-- Key = 'ABC' 
})
...
--Credits To Server Member In Syde.
